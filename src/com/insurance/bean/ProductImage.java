...
public class ProductImage {
	...
	private String bigPhotosImagePath;//首页相册图片（大）路径
	private String smallPhotosImagePath;//商品图片(小)路径
	...
	public String getBigPhotosImagePath() {
		return bigPhotosImagePath;
	}

	public void setBigPhotosImagePath(String bigPhotosImagePath) {
		this.bigPhotosImagePath = bigPhotosImagePath;
	}

	public String getSmallPhotosImagePath() {
		return smallPhotosImagePath;
	}

	public void setSmallPhotosImagePath(String smallPhotosImagePath) {
		this.smallPhotosImagePath = smallPhotosImagePath;
	}
