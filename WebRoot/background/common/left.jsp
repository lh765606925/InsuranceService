...
<body>
	<div class="left_top">
		...
		<span class="nav_name">主页管理</span> <img class="left_top_"
	...
	<div class="left_down">
		...
		<!-- 
			<div class="nav_son">
				<a href="${pageContext.request.contextPath}/back/upload_appupdate.action" id="son2" class="nav_son_name"><span>APP更新</span></a>
			</div>
		 -->
	</div>
</body>
