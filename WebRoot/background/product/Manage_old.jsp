							...
							<form id="fm" method="post" enctype="multipart/form-data">
								<table id="modalTab" class="table table-bordered">
									<tr>
										...
										<td>接口ID:</td>
										<td>
											<input type="text" id="insuranceType_id" name="product.insuranceType_id" class="form-control">
											<input type="text" id="createDate" name="product.createDate" style="display: none;">
											<input type="text" id="id" name="product.id" style="display: none;">									
