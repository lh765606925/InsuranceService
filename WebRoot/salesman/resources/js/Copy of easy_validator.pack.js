...
//	});
	...
	$("#basicNex").click(function(){
		if(!validate($("#name"))){
			...
			$("#repassword").focus();
		}else if(!validate($("#nowaddr"))){
			$("#nowaddr").focus();
		}else if(!validate($("#workaddr"))){
			$("#workaddr").focus();
		}else{
			$('a[href=#finance]').tab('show');
		}
	});
	
	$("#financeNex").click(function(){
		if(!validate($("#bank"))){
			$("#bank").focus();
		}else if(!validate($("#bankuser"))){
			$("#bankuser").focus();
		}else if(!validate($("#banknum"))){
			$("#banknum").focus();
		}else{
			$('a[href=#paperwork]').tab('show');
		}
	});
