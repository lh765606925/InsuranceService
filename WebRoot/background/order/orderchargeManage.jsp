		...
		<div class="data_content">
			...
			<div class="main_table">
				...
				<table id="productTable" class="table-condensed"
					...
					data-url="${pageContext.request.contextPath}/back/ordercharge_list.action"
					data-cache="false" data-height="512" data-click-to-select="true">
					<thead>
						<tr style="font-size: 1.2em;">
							<th data-field="state" data-checkbox="true"></th>
							<th data-field="payer" data-width="10">支付方</th>
							<th data-field="payAmount" data-width="60">支付金额</th>
							<th data-field="payBusinessCode" data-width="20">交易号</th>
							<th data-field="payCode" data-width="80">支付流水号</th>
							<th data-field="sellerAccountUsername" data-width="10">付款账号</th>
							<th data-field="payMethod" data-width="10">支付方式</th>
