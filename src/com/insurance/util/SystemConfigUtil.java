...
public class SystemConfigUtil {
	...
	public static final String CONFIG_FILE_NAME = "system.xml";// 系统配置文件名称
...
//		SystemConfig systemConfig = (SystemConfig) OsCacheConfigUtil.getFromCache(SYSTEM_CONFIG_CACHE_KEY);
		...
		try {
			configFile = new ClassPathResource(CONFIG_FILE_NAME).getFile();//Thread.currentThread().getContextClassLoader().getResource("").toURI().getPath() + CONFIG_FILE_NAME;
		...
		Node systemNameNode = document.selectSingleNode("/config/systemConfig/systemName");
		Node systemVersionNode = document.selectSingleNode("/config/systemConfig/systemVersion");
		Node systemDescriptionNode = document.selectSingleNode("/config/systemConfig/systemDescription");
		Node isInstalledNode = document.selectSingleNode("/config/systemConfig/isInstalled");
		Node shopNameNode = document.selectSingleNode("/config/systemConfig/shopName");
		Node shopUrlNode = document.selectSingleNode("/config/systemConfig/shopUrl");
		Node shopLogoNode = document.selectSingleNode("/config/systemConfig/shopLogo");
		Node hotSearchNode = document.selectSingleNode("/config/systemConfig/hotSearch");
		Node metaKeywordsNode = document.selectSingleNode("/config/systemConfig/metaKeywords");
		Node metaDescriptionNode = document.selectSingleNode("/config/systemConfig/metaDescription");
		Node addressNode = document.selectSingleNode("/config/systemConfig/address");
		Node phoneNode = document.selectSingleNode("/config/systemConfig/phone");
		Node zipCodeNode = document.selectSingleNode("/config/systemConfig/zipCode");
		Node emailNode = document.selectSingleNode("/config/systemConfig/email");
		Node currencyTypeNode = document.selectSingleNode("/config/systemConfig/currencyType");
		Node currencySignNode = document.selectSingleNode("/config/systemConfig/currencySign");
		Node currencyUnitNode = document.selectSingleNode("/config/systemConfig/currencyUnit");
		Node priceScaleNode = document.selectSingleNode("/config/systemConfig/priceScale");
		Node priceRoundTypeNode = document.selectSingleNode("/config/systemConfig/priceRoundType");
		Node orderScaleNode = document.selectSingleNode("/config/systemConfig/orderScale");
		Node orderRoundTypeNode = document.selectSingleNode("/config/systemConfig/orderRoundType");
		Node certtextNode = document.selectSingleNode("/config/systemConfig/certtext");
		Node storeAlertCountNode = document.selectSingleNode("/config/systemConfig/storeAlertCount");
		Node storeFreezeTimeNode = document.selectSingleNode("/config/systemConfig/storeFreezeTime");
		Node uploadLimitNode = document.selectSingleNode("/config/systemConfig/uploadLimit");
		Node isLoginFailureLockNode = document.selectSingleNode("/config/systemConfig/isLoginFailureLock");
		Node loginFailureLockCountNode = document.selectSingleNode("/config/systemConfig/loginFailureLockCount");
		Node loginFailureLockTimeNode = document.selectSingleNode("/config/systemConfig/loginFailureLockTime");
		Node isRegisterNode = document.selectSingleNode("/config/systemConfig/isRegister");
		Node watermarkImagePathNode = document.selectSingleNode("/config/systemConfig/watermarkImagePath");
		Node watermarkPositionNode = document.selectSingleNode("/config/systemConfig/watermarkPosition");
		Node watermarkAlphaNode = document.selectSingleNode("/config/systemConfig/watermarkAlpha");
		Node bigProductImageWidthNode = document.selectSingleNode("/config/systemConfig/bigProductImageWidth");
		Node bigProductImageHeightNode = document.selectSingleNode("/config/systemConfig/bigProductImageHeight");
		Node smallProductImageWidthNode = document.selectSingleNode("/config/systemConfig/smallProductImageWidth");
		Node smallProductImageHeightNode = document.selectSingleNode("/config/systemConfig/smallProductImageHeight");
		Node thumbnailProductImageWidthNode = document.selectSingleNode("/config/systemConfig/thumbnailProductImageWidth");
		Node thumbnailProductImageHeightNode = document.selectSingleNode("/config/systemConfig/thumbnailProductImageHeight");
		
		Node bigArticleImageWidthNode = document.selectSingleNode("/config/systemConfig/bigArticleImageWidth");
		Node bigArticleImageHeightNode = document.selectSingleNode("/config/systemConfig/bigArticleImageHeight");
		Node smallArticleImageWidthNode = document.selectSingleNode("/config/systemConfig/smallArticleImageWidth");
		Node smallArticleImageHeightNode = document.selectSingleNode("/config/systemConfig/smallArticleImageHeight");
		Node thumbnailArticleImageWidthNode = document.selectSingleNode("/config/systemConfig/thumbnailArticleImageWidth");
		Node thumbnailArticleImageHeightNode = document.selectSingleNode("/config/systemConfig/thumbnailArticleImageHeight");
		//图集大小
		Node bigPhotosImageWidthNode = document.selectSingleNode("/config/systemConfig/bigPhotosImageWidth");
		Node bigPhotosImageHeightNode = document.selectSingleNode("/config/systemConfig/bigPhotosImageHeight");
		Node smallPhotosImageWidthNode = document.selectSingleNode("/config/systemConfig/smallPhotosImageWidth");
		Node smallPhotosImageHeightNode = document.selectSingleNode("/config/systemConfig/smallPhotosImageHeight");
		
		Node defaultBigProductImagePathNode = document.selectSingleNode("/config/systemConfig/defaultBigProductImagePath");
		Node defaultSmallProductImagePathNode = document.selectSingleNode("/config/systemConfig/defaultSmallProductImagePath");
		Node defaultThumbnailProductImagePathNode = document.selectSingleNode("/config/systemConfig/defaultThumbnailProductImagePath");
		Node allowedUploadImageExtensionNode = document.selectSingleNode("/config/systemConfig/allowedUploadImageExtension");
		Node allowedUploadMediaExtensionNode = document.selectSingleNode("/config/systemConfig/allowedUploadMediaExtension");
		Node allowedUploadFileExtensionNode = document.selectSingleNode("/config/systemConfig/allowedUploadFileExtension");
		Node smtpFromMailNode = document.selectSingleNode("/config/systemConfig/smtpFromMail");
		Node smtpHostNode = document.selectSingleNode("/config/systemConfig/smtpHost");
		Node smtpPortNode = document.selectSingleNode("/config/systemConfig/smtpPort");
		Node smtpUsernameNode = document.selectSingleNode("/config/systemConfig/smtpUsername");
		Node smtpPasswordNode = document.selectSingleNode("/config/systemConfig/smtpPassword");
		Node backSmtpFromMailNode = document.selectSingleNode("/config/systemConfig/backSmtpFromMail");
		Node backSmtpHostNode = document.selectSingleNode("/config/systemConfig/backSmtpHost");
		Node backSmtpPortNode = document.selectSingleNode("/config/systemConfig/backSmtpPort");
		Node backSmtpUsernameNode = document.selectSingleNode("/config/systemConfig/backSmtpUsername");
		Node backSmtpPasswordNode = document.selectSingleNode("/config/systemConfig/backSmtpPassword");
		Node receiveMailNode = document.selectSingleNode("/config/systemConfig/receiveMail");
		
		Node pointTypeNode = document.selectSingleNode("/config/systemConfig/pointType");
		Node pointScaleNode = document.selectSingleNode("/config/systemConfig/pointScale");
		Node retainNameNode = document.selectSingleNode("/config/systemConfig/retainName");
		Node receiveMailToSpecialNode = document.selectSingleNode("/config/systemConfig/receiveMailToSpecial");
...
//		
//		//图集
//		systemConfig.setBigPhotosImageWidth(Integer.valueOf(bigPhotosImageWidthNode.getText()));
//		systemConfig.setBigPhotosImageHeight(Integer.valueOf(bigPhotosImageHeightNode.getText()));
//		systemConfig.setSmallPhotosImageWidth(Integer.valueOf(smallPhotosImageWidthNode.getText()));
//		systemConfig.setSmallPhotosImageHeight(Integer.valueOf(smallPhotosImageHeightNode.getText()));
//		
//		systemConfig.setBigArticleImageWidth(Integer.valueOf(bigArticleImageWidthNode.getText()));
//		systemConfig.setBigArticleImageHeight(Integer.valueOf(bigArticleImageHeightNode.getText()));
//		systemConfig.setSmallArticleImageWidth(Integer.valueOf(smallArticleImageWidthNode.getText()));
//		systemConfig.setSmallArticleImageHeight(Integer.valueOf(smallArticleImageHeightNode.getText()));
//		systemConfig.setThumbnailArticleImageWidth(Integer.valueOf(thumbnailArticleImageWidthNode.getText()));
//		systemConfig.setThumbnailArticleImageHeight(Integer.valueOf(thumbnailArticleImageHeightNode.getText()));
//		
...
//		
//		systemConfig.setBackSmtpFromMail(backSmtpFromMailNode.getText());
//		systemConfig.setBackSmtpHost(backSmtpHostNode.getText());
//		systemConfig.setBackSmtpPort(Integer.parseInt(backSmtpPortNode.getText()));
//		systemConfig.setBackSmtpUsername(backSmtpUsernameNode.getText());
//		systemConfig.setBackSmtpPassword(backSmtpPasswordNode.getText());
//		
//		systemConfig.setReceiveMail(receiveMailNode.getText());
//		systemConfig.setReceiveMailToSpecial(receiveMailToSpecialNode.getText());
//		
...
//		systemConfig.setRetainName(retainNameNode.getText());
//		
//		OsCacheConfigUtil.putInCache(SYSTEM_CONFIG_CACHE_KEY, systemConfig);
	...
	public static void update(SystemConfig systemConfig) {
		...
		try {
			...
			configFile = new ClassPathResource(CONFIG_FILE_NAME).getFile();//new File(configFilePath);
			SAXReader saxReader = new SAXReader();
			document = saxReader.read(configFile);
		} catch (Exception e) {
			e.printStackTrace();
		...
		//图集
		if(bigPhotosImageWidthNode == null){
			bigPhotosImageWidthNode = systemConfigElement.addElement("bigPhotosImageWidth");
		}
		if(bigPhotosImageHeightNode == null){
			bigPhotosImageHeightNode = systemConfigElement.addElement("bigPhotosImageHeight");
		}
		if(smallPhotosImageWidthNode == null){
			smallPhotosImageWidthNode = systemConfigElement.addElement("smallPhotosImageWidth");
		}
		if(smallPhotosImageHeightNode == null){
			smallPhotosImageHeightNode = systemConfigElement.addElement("smallPhotosImageHeight");
		}
		
		// article potos
		if(bigArticleImageWidthNode == null){
			bigArticleImageWidthNode = systemConfigElement.addElement("bigArticleImageWidth");
		}
		if(bigArticleImageHeightNode == null){
			bigArticleImageHeightNode = systemConfigElement.addElement("bigArticleImageHeight");
		}
		if(smallArticleImageWidthNode == null){
			smallArticleImageWidthNode = systemConfigElement.addElement("smallArticleImageWidth");
		}
		if(smallArticleImageHeightNode == null){
			smallArticleImageHeightNode = systemConfigElement.addElement("smallArticleImageHeight");
		}
		if(thumbnailArticleImageWidthNode == null){
			thumbnailArticleImageWidthNode = systemConfigElement.addElement("thumbnailArticleImageWidth");
		}
		if(thumbnailArticleImageHeightNode == null){
			thumbnailArticleImageHeightNode = systemConfigElement.addElement("thumbnailArticleImageHeight");
		}
		//
		...
		if(backSmtpFromMailNode == null){
			backSmtpFromMailNode = systemConfigElement.addElement("backSmtpFromMail");
		}
		if(backSmtpHostNode == null){
			backSmtpHostNode = systemConfigElement.addElement("backSmtpHost");
		}
		if(backSmtpPortNode == null){
			backSmtpPortNode = systemConfigElement.addElement("backSmtpPort");
		}
		if(backSmtpUsernameNode == null){
			backSmtpUsernameNode = systemConfigElement.addElement("backSmtpUsername");
		}
		if(backSmtpPasswordNode == null){
			backSmtpPasswordNode = systemConfigElement.addElement("backSmtpPassword");
		}
		
		if(receiveMailNode == null){
			receiveMailNode = systemConfigElement.addElement("receiveMail");
		}
		if (receiveMailToSpecialNode == null) {
		      receiveMailToSpecialNode = systemConfigElement.addElement("receiveMailToSpecial");
		}
		...
		//图集
//		bigPhotosImageWidthNode.setText(String.valueOf(systemConfig.getBigPhotosImageWidth()));
//		bigPhotosImageHeightNode.setText(String.valueOf(systemConfig.getBigPhotosImageHeight()));
//		smallPhotosImageWidthNode.setText(String.valueOf(systemConfig.getSmallPhotosImageWidth()));
//		smallPhotosImageHeightNode.setText(String.valueOf(systemConfig.getSmallPhotosImageHeight()));
//		//article photo
//		bigArticleImageWidthNode.setText(String.valueOf(systemConfig.getBigArticleImageWidth()));
//		bigArticleImageHeightNode.setText(String.valueOf(systemConfig.getBigArticleImageHeight()));
//		smallArticleImageWidthNode.setText(String.valueOf(systemConfig.getSmallArticleImageWidth()));
//		smallArticleImageHeightNode.setText(String.valueOf(systemConfig.getSmallArticleImageHeight()));
//		thumbnailArticleImageWidthNode.setText(String.valueOf(systemConfig.getThumbnailArticleImageWidth()));
//		thumbnailArticleImageHeightNode.setText(String.valueOf(systemConfig.getThumbnailArticleImageHeight()));
//		//
...
//		//保留关键字
//		retainNameNode.setText(systemConfig.getRetainName());
//		
...
//		
//		backSmtpFromMailNode.setText(systemConfig.getBackSmtpFromMail());
//		backSmtpHostNode.setText(systemConfig.getBackSmtpHost());
//		backSmtpPortNode.setText(String.valueOf(systemConfig.getBackSmtpPort()));
//		backSmtpUsernameNode.setText(systemConfig.getBackSmtpUsername());
//		backSmtpPasswordNode.setText(systemConfig.getBackSmtpPassword());
//		
//		receiveMailNode.setText(systemConfig.getReceiveMail());
//		receiveMailToSpecialNode.setText(systemConfig.getReceiveMailToSpecial());
