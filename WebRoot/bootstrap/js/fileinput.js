...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超过最高大小 <b>{maxSize} KB</b>. 请重新上传!',
        msgFilesTooMany: '您选择上传的文件数量为 <b>({n})</b> 已经超过最大允许数量 <b>{m}</b>. 请重新上传!',
        msgFileNotFound: 'File "{name}" not found!',
        msgFileNotReadable: 'File "{name}" is not readable.',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'An error occurred while reading the file "{name}".',
        msgInvalidFileType: 'Invalid type for file "{name}". 只支持 "{types}" 类型的文件.',
        msgInvalidFileExtension: '扩展无效的文件 "{name}". 只支持 "{extensions}" 扩展的文件.',
        ...
        dropZoneTitle: '可以在这里拖放文件 &hellip;',
