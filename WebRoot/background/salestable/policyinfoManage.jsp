...
<script type="text/javascript">
	...
	function fillForm(row) {
		...
		$("input#policyHolder_name").val(row.policyHolder_name);
		$("input#product_name").val(row.product_name);
		$("input#applyCode").val(row.applyCode);
	}
		...
		<div class="data_content">
			...
			<div class="main_table">
				...
				<table id="productTable" class="table-condensed"
					...
					data-url="${pageContext.request.contextPath}/back/policyinfo_list.action"
					data-cache="false" data-height="512" data-click-to-select="true">
					<thead>
						<tr style="font-size: 1.2em;">
							<th data-field="state" data-checkbox="true"></th>
							<th data-field="policyHolder_name" data-width="60">投保人</th>
							<th data-field="product_name" data-width="120">产品</th>
							<th data-field="applyCode" data-width="120" style="width:40px">保单流水号</th>
							<th data-field="amount" data-width="20">保单总额</th>
							<th data-field="createDate" data-width="80">投保时间</th>
