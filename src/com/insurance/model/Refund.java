 ...
 * 实体类 - 退款
 * ============================================================================
 * 版权所有 2008-2010 艺龙设计有限公司 ，并保留所有权利。
 * ----------------------------------------------------------------------------
 * 提示：在未取得ArtLongs商业授权之前，您不能将本软件应用于商业用途，否则ArtLongs将保留追究的权力。
 * ----------------------------------------------------------------------------
 * 官方网站：http://www.artlongs.com
 * ----------------------------------------------------------------------------
 * KEY: ARTLONGS7F96199874A941DAF2B4817C397C676A
 * ============================================================================
 */
